...
<div class="movie-list-index">
    <h2 class="header-list-index"><span class="title-list-index">Phim tâm lý</span><a class="more-list-index" href="<?php echo base_url()?>the-loai/tam-ly/" title="Phim tâm lý mới cập nhật">Xem tất cả</a></h2>
    <div class="list_carousel">
        <ul class="last-film-box" data-categoryid="9" id="movie-carousel-9" >
            <?php if (isset($phim_tam_ly) && is_array($phim_tam_ly)): ?>
                <?php foreach ($phim_tam_ly as $row): ?>
                    <li>
        ...
        <a id="prev9" class="prev" rel="nofollow" style="display: block;"><span class="arrow-icon left"></span></a>
        <a id="next9" class="next" rel="nofollow" style="display: block;"><span class="arrow-icon right"></span></a>
